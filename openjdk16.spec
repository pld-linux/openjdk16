...
Obsoletes:	jdk
Obsoletes:	kaffe
Obsoletes:	openjdk16-jdk < 16.0.2-3
Obsoletes:	oracle-java7
...
Provides:	jdk(%{name})
Obsoletes:	openjdk16-jdk-base < 16.0.2-3
...
Obsoletes:	jre
Obsoletes:	jsse
Obsoletes:	openjdk16-jre < 16.0.2-3
Obsoletes:	oracle-java7-jre
...
Provides:	jre(%{name})
Obsoletes:	openjdk16-jre-base < 16.0.2-3
...
Obsoletes:	openjdk16-jre-base-X11 < 16.0.2-3
...
Obsoletes:	openjdk16-jre-base-freetype < 16.0.2-3
...
Obsoletes:	jar
Obsoletes:	openjdk16-jar < 16.0.2-3
